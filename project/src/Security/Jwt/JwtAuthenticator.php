...
final class JwtAuthenticator extends AbstractAuthenticator
{
    ...
    public function supports(Request $request): ?bool
    {
        ...
        if (preg_match('#^/api/auth/(login|signin|register|signup|refresh|logout|forgot-password|verify-reset-code|reset-password|reset/send|reset/confirm|face/login|google/connect|google/callback)$#', $path) === 1) {
            return false;
        }
