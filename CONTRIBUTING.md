# Contributing to serinity-web

Thank you for your interest in contributing to serinity-web! Contributions from the community are welcome and appreciated.
...
2. Clone your fork to your local machine:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/serinity-web.git
   ```
...
Please check the [issues](https://github.com/serinity-web/issues) tab to see where help is needed.
...
By contributing to serinity-web, you agree that your contributions will be licensed under the same license as the project.
